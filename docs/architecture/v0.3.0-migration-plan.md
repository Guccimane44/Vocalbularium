...
**Status: owner authorized implementation on 22 September 2026. Stage 1 is in progress.**
...
- Add strict type checking and build configuration; allow a temporary mixed JS/TS transition with an explicit removal endpoint.
